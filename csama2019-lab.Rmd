...
```{r centroided, fig.cap = "Raw profile mode data (left) as measured by the mass spectrometre, and processed, centroided data (right).", echo = FALSE}
...
```{r featsfig2, fig.cap = "Examples of aggregation from PSMs, peptides to proteins using median aggregation (from the [`Features`](https://rformassspectrometry.github.io/Features/articles/Features.html) package).", echo = FALSE}
