...
<!-- <div class="boxed blue">Beginner</div><div class="boxed purple">Foo</div><div class="boxed yellow">Bar</div><br/> -->
...
Mass spectrometry (MS) is a technology that *separates* charges
...
The animation below, produced with the `r Githubpkg("mstut")` package
show how 25 ions different ions (i.e. having different M/Z values) are
separated throughout the MS analysis and are eventually detected
(i.e. quantified). The final frame shows the hypothetical spectrum.
