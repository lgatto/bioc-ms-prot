...
We first download the fasta files from ProteomeXchange (that file is
also available in the proteomics lab directory on the CSAMA workshop).
...
The `mzTab` file is also available in the is also available in the
proteomics lab directory in the CSAMA workshop server.
