...
date: "[CSAMA](https://www.huber.embl.de/csama2019/) - Bressanone - 25 July 2019"
output:
...
Quantitative proteomics data analysis using Bioconductor tools
...
You will be use the`r BiocStyle::Biocpkg("MSnbase")` and `r BiocStyle::Githubpkg("statOmics/MSqRob")` packages during the lab.
...
- mixture thereof - for example `impute(, method = "mixed")` (used in `r BiocStyle::Biocpkg("DEP")`)
...
```{r summarisation, echo = FALSE}
knitr::include_graphics("./Figures/summarisation.jpg")
```
...
### Two stage differential analysis
...
[Johannes Rainer](https://github.com/jorainer) (software development)
